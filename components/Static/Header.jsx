                ...
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            <img src="https://cdn.discordapp.com/attachments/1006962822363750401/1060312614892220416/Junibot_Community.webp" 
                                className={`
                                    rounded-full 
                                `}
                                width="48" height="48"
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">JUNI</span>BOT</a>
                            </p>
                        </div>
